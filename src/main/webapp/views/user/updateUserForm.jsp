	...
	<section id="root">
		...
		<form method="POST" action="/updateUserFormAction">
			...
			<div>
				...
				<div id="radio-container">
					<input type="radio" class="gender" id="gender-man" name="gender"
						value="M" ${user.gender eq 'M' ? 'checked' : ''}> <input
						type="radio" class="gender" id="gender-woman" name="gender"
						value="F" ${user.gender eq 'F' ? 'checked' : ''}> <input
						type="radio" class=country id="country-local" name="country"
						value="local" ${user.country eq 'local' ? 'checked' : ''}>
					<input type="radio" class=country id="country-foreigner"
						name="country" value="foreigner"
						${user.country eq 'foreigner' ? 'checked' : ''}>
					<div>
			...
			<div id="agree-container">
				<input type="checkbox" id="agree" name="agree" checked> <label
					for="agree" id="agree-label">
					<p>
